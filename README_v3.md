...
│   ├── evt_scorer_v3.py                    # GPD tail fit on hybrid + subspace scores
│   ├── self_training_loop_v3.py            # Pseudo-label promotion (human-gated)
│   ├── fusion_classifier_v3.py             # LightGBM: 2 scores → 1 risk score
│   ├── xai_layer_v3.py                     # Per-feature conditional errors + narratives
│   └── evaluate_model_v3.py                # Degree-stratified PR-AUC + edge-dropout
│
├── data/
...
│
└── docs/
    ├── AGENTS_v3.md                        # Architecture contract (do not edit autonomously)
    ├── AGENTS_v2_rulefree.md               # V2 reference (do not modify)
    └── MAR_v2.md                           # V2 Model and Architecture Review
```
